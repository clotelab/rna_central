...
var proto = module.exports = function(options) {
  ...
  router.get("/jobs/:nickname", function(req, res, next) {
    ...
    if (job) {
      res.locals.current_tab = { title: job.nickname };
...
_.extend(proto, {
  ...
  add_tab: function(tab_settings) {
    ...
    tab_settings.content = tab_settings.content || {};
    ...
    if (_.include(tab_settings.path, "/submit_job")) {
  ...
  add_form_submission_route: function(server_tab) {
    ...
    this.post(server_tab.path, function(req, res, next) {
